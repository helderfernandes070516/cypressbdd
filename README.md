...
<p align="center">
  <a href="https://www.cypress.io">
    <picture>
      <source media="(prefers-color-scheme: dark)"  srcset="./cypress/cypress-logo-dark.png">
      <source media="(prefers-color-scheme: light)" srcset="./cypress/cypress-logo-light.png">
...
To run all the tests, run the follow command:
```bash
npm cypress run
```
Or you can open CLI interface from Cypress to run the tests that you want:
```bash
npx cypress open 
```
